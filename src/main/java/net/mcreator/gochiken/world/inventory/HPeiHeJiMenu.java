...
public class HPeiHeJiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public HPeiHeJiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(GochickenModMenus.H_PEI_HE_JI.get(), id);
