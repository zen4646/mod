...
public class Layerlv1GUIScreen extends AbstractContainerScreen<Layerlv1GUIMenu> {
	...
	public Layerlv1GUIScreen(Layerlv1GUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("gochicken:textures/screens/layerlv_1_gui.png");
