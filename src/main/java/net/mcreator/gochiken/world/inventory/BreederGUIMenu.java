...
public class BreederGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public BreederGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(GochickenModMenus.BREEDER_GUI.get(), id);
