...
@Mod("gochiken")
public class GochikenMod {
	public static final Logger LOGGER = LogManager.getLogger(GochikenMod.class);
	public static final String MODID = "gochiken";

	public GochikenMod() {
		MinecraftForge.EVENT_BUS.register(this);
		GochikenModTabs.load();
